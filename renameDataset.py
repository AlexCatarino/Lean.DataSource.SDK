...
if __name__ == "__main__":
    vendorNameDatasetName = os.path.basename(CWD).replace('Lean.DataSource.','')
    vendorNameDatasetNameUniverse=f'{vendorNameDatasetName}Universe'

    # In the devcontainer.json, rename the MyCustomDataDownloader to {vendorNameDatasetNameUniverse}DataDownloader
    RenameFileContent('.devcontainer\devcontainer.json', 'MyCustomDataType', os.path.basename(CWD))
